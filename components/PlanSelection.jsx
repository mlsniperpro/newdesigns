...
function PlanSelection() {
  ...
  return (
    <>
      ...
      <div className="flex min-h-screen pt-[30px] px-[40px]" style={{background:'white'}}>
        <div className="min-w-full">
          <p className="text-[#00153B] text-[20px] leading-[40px] font-semibold" style={{color:"black",fontSize:'bolder',fontFamily:"Monospace",fontSize:'40px'}}>
          ...
          <div>
            <p className="text-[#717F87] text-[15px] leading-[27px] font-medium"  style={{color:"black",fontSize:'bolder',fontFamily:"Monospace",fontSize:'20px'}}>
          ...
          <div className="mt-[30px] inline-flex border border-[#E1E3E5] shadow-[0px 1px 2px #E1E3E5] divide-[#E1E3E5] divide-x rounded-[5px]" >
            <button className="bg-white hover:bg-[#F6F6F7] hover:text-[#717F87] text-[#0E1823] leading-[16px] text-[13px] font-semibold font-bold py-[15px] px-[25px] rounded-l"style={{background:'#283081',color:'white',fontFamily:"Monospace",fontSize:'18px'}}>
              <Link href="/">
                <MoneyOffIcon style={{marginRight:"10px"}}/>
                {language === "english" ? "Free" : "Gratis"}</Link>
            </button>
            <button className="bg-white hover:bg-[#F6F6F7] hover:text-[#717F87] text-[#0E1823] text-[13px] leading-[16px] font-semibold font-bold py-[15px] px-[25px] rounded-r" style={{background:'#283081',color:'white',fontFamily:"Monospace",fontSize:'18px'}}>
          ...
          <div className="mt-[20px] grid grid-cols-3 gap-[20px]" >
            ...
            >
              <div className="pt-[15px] px-[25px] pb-[25px]">
                <div className="flex justify-end">
                  <div className="bg-[#F6F6F7] rounded-[20px] flex justify-center align-center px-[12px]">
                    <p className="text-[#00153B] text-[12px] leading-[28px] font-bold" style={{fontFamily:"Monospace",fontSize:'16px'}}>
                      {language === "english" ? "Starter" : "Principiante"}
                    </p>
                  </div>
                </div>
                <div>
                  <p className="text-[#00153B] text-[19px] leading-[24px] font-bold" style={{color:'white',fontFamily:"Monospace",fontSize:'30px'}}>
                    {language === "english" ? "Basic" : "Básico"}
                  </p>
                  <p className="text-[#00153B] text-[50px] leading-[63px] font-bold" style={{color:'white'}}>
                    {language === "english" ? "FREE" : "GRATIS"}
                  </p>
                </div>
                <div>
                  <p className="text-[#717F87] text-[18px] leading-[28px] font-medium" style={{color:'white',fontFamily:"Monospace",fontSize:'20px'}}>
              ...
              <div className="pt-[25px] px-[25px] pb-[35px]">
                <div>
                  <p className="text-[#717F87] text-[14px] leading-[24px] font-medium" style={{color:'white',fontFamily:"Monospace",fontSize:'16px'}}>
                    {language === "english"
                ...
                <div className="mt-[25px]">
                  <button
                    ...
                    style={{color:"#283081",fontFamily:"Monospace",fontSize:'18px'}}
                  >
                    {language === "english"
                      ? "Switch to Spanish"
                      : "Cambiar a inglés"}
           ...
           >
              <div className="pt-[15px] px-[25px] pb-[25px]">
                ...
                <div>
                  <p className="text-[#00153B] text-[19px] leading-[24px] font-bold"style={{color:'white',fontFamily:"Monospace",fontSize:'24px'}}>
                    {language === "english" ? "Monthly" : "Mensual"}
                  </p>
                  <p className="text-[#00153B] text-[50px] leading-[63px] font-bold" style={{color:'white'}}>
                    {monthly} USD
                ...
                <div>
                  <p className="text-[#717F87] text-[18px] leading-[28px] font-medium" style={{color:'white'}}>
                    {language === "english"
                      ? "  Unlimited Usage"
                      : " Uso Ilimitado"}
                  </p>
              ...
              <div className="pt-[25px] px-[25px] pb-[35px]">
                ...
                <div className="mt-[25px]">
                  <button className="bg-[white] rounded-[5px] py-[15px] px-[25px] text-[#fff] text-[14px] leading-[17px] font-semibold" style={{color:'#283081',fontFamily:"Monospace",fontSize:'18px'}}>
                    <Link href="/monthly">
                      {language === "english"
                        ? "Select Plan"
                        : "Seleccionar Plan"}
           ...
           >
              <div className="pt-[15px] px-[25px] pb-[25px]">
                ...
                <div>
                  <p className="text-[#717F87] text-[18px] leading-[28px] font-medium"style={{color:'white',fontFamily:"Monospace",fontSize:'21px'}}>
                    {language === "english"
                      ? "  Unlimited Usage"
                      : "  Uso Ilimitado"}
                  </p>
              ...
              <div className="pt-[25px] px-[25px] pb-[35px]">
                ...
                <div className="mt-[25px]">
                  <button className="bg-[white] rounded-[5px] py-[15px] px-[25px] text-[#fff] text-[14px] leading-[17px] font-semibold" style={{color:"#283081",fontFamily:"Monospace",fontSize:'18px'}}>
                    <Link href="/yearly">
                      {language === "english" ? "Upgrade " : "Mejorar "} <UpgradeIcon />
                    </Link>
                  </button>
                </div>
              </div>
